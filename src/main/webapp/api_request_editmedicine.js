...
var url = 'https://localhost:8765/observatory/api/products/' + localStorage.getItem("prodEditId");
...
function error()
{
 	var errorString = "Υπήρξε ένα σφάλμα κατά την επεξεργασία φαρμάκου. Προσπαθήστε αργότερα.";
...
request.onreadystatechange = function () 
{
	...
	if(request.readyState == 4) // replacement for request.onload
	{
		...
		{
			var successText = document.createTextNode("Επιτυχής επεξεργασία φαρμάκου!");
