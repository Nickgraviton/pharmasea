...
var url = 'https://localhost:8765/observatory/api/shops/' + localStorage.getItem("shopEditId");
...
function error()
{
 	var errorString = "Υπήρξε ένα σφάλμα κατά την επεξεργασία φαρμακείου. Προσπαθήστε αργότερα.";
...
request.onreadystatechange = function () 
{
	...
	if(request.readyState == 4) // replacement for request.onload
	{
		...
		{
			var successText = document.createTextNode("Επιτυχής επεξεργασία φαρμακείου!");
